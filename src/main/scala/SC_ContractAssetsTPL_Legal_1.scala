...
final case class SC_ContractAssetsTPL_Legal_1TransferForLegal(from:String, to:String, amount:Int, remind:String)
class SC_ContractAssetsTPL_Legal_1 extends IContract{
  ...
  implicit val formats = DefaultFormats
    ...
    def transfer(ctx: ContractContext, data:SC_ContractAssetsTPL_Legal_1TransferForLegal) :ActionResult={
    ...
    def onAction(ctx: ContractContext,action:String, sdata:String ):ActionResult={
      ...
      action match {
        case "transfer" => 
          transfer(ctx,json.extract[SC_ContractAssetsTPL_Legal_1TransferForLegal])
        case "set" => 
