...
final case class SC_TestTPL_1TransferForLegal2(from:String, to:String, amount:Int, remind:String)
class SC_TestTPL_1 extends IContract{
  ...
  def transfer(ctx: ContractContext, data:SC_TestTPL_1TransferForLegal2) :ActionResult={
  ...
  def onAction(ctx: ContractContext,action:String, sdata:String ):ActionResult={
    ...
    action match {
      case "transfer" =>
        transfer(ctx,json.extract[SC_TestTPL_1TransferForLegal2])
      case "set" =>
